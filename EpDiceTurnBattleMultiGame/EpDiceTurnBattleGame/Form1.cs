...
namespace EpDiceTurnBattleGame
{
    ...
    public partial class Form1 : GameManager
    {
        ...
        private Random patten = new Random();
        private Random critical = new Random();
        private EpDice dice = new EpDice();
    ...
    private void BoolSetting()
        ...
        private void Panel_Paint(object sender, PaintEventArgs e)
        {
            ...
            else
            {
                ...
                e.Graphics.DrawImage(buttonStart, MultiPlayButton);
            }
        }
        ...
        private void EMouseDown(object sender, MouseEventArgs e)
        {
            if (!gameStart)
            {
                ...
                if (MultiPlayButton.Contains(e.X, e.Y))
                {
                    gameStart = true;
